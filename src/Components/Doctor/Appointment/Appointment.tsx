...
const Appointment: React.FC = () => {
  ...
  const user = { profileId: "5" }; // replace with your selector
...
const filteredAppointment = appointments.filter((appointment) => {
 ...
 const fatchData = ()=>{
      getAppointmentByDoctor(user.profileId)
  .then((data) => {
    console.log(data);
  ...
  return (
    <div className="card">
       <Toolbar className="mb-4" left={centerToolbarTemplate}  right={rightToolbarTemplate}></Toolbar>
      {/* Data Table */}
      <DataTable
        stripedRows
